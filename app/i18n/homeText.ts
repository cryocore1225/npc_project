...
const zh: Localized = {
  eyebrow: 'N.P.C 智能分类',
  appTitle: '垃圾分类助手',
  intro: '拍照或上传图片，使用 ONNX Runtime Web 在浏览器中识别垃圾类型并给出投放建议。',
  languageLabel: '语言',
  langZh: '中文',
  langKo: '한국어',
  statusLoading: '模型加载中...',
  ...
  statusMissingHint: '请将 model.onnx 放到 public/model/。',
  statusError: '模型加载失败。',
...
const ko: Localized = {
  ...
  appTitle: '쓰레기 분류 도우미',
  intro: '사진 촬영 또는 이미지 업로드 후 ONNX Runtime Web으로 분류 결과와 배출 가이드를 제공합니다.',
  languageLabel: '언어',
  langZh: '中文',
  langKo: '한국어',
  ...
  statusMissingHint: 'public/model/에 model.onnx를 배치하세요.',
