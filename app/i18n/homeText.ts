import type { Lang, LabelKey } from './shared'
...
export type Localized = {
  ...
  reasonHints: Record<string, string>
...
const zh: Localized = {
  ...
  statusMissingHint: '请将 model.json 与 group1-shard*.bin 放到 public/model/。',
  statusError: '模型加载失败。',
  ...
  rawLabels: {
    ...
    rag: '抹布',
    shoes: '鞋类',
    tabletcapsule: '药片/胶囊板',
    textiletrash: '织物垃圾',
    thermometer: '温度计',
    toothbrush: '牙刷',
    toothpastetube: '牙膏管',
    toothpick: '牙签',
    traditionalchinesemedicine: '中药渣',
    trash: '其他垃圾',
    vegetation: '植物残渣',
    'white-glass': '白色玻璃',
    whiteglass: '白色玻璃',
...
const ko: Localized = {
  ...
  statusMissingHint: 'public/model/에 model.json과 group1-shard*.bin을 배치하세요.',
  ...
  rawLabels: {
    ...
    metal: '금속',
    milkbox: '우유팩',
    miscellaneoustrash: '일반 쓰레기',
    nailpolishbottle: '매니큐어 병',
    napkin: '냅킨',
    newspaper: '신문',
    nut: '견과류 껍질',
    paper: '종이',
    ...
    rag: '걸레',
    shoes: '신발',
    tabletcapsule: '알약/캡슐 포장',
    textiletrash: '섬유류 폐기물',
    thermometer: '온도계',
    toothbrush: '칫솔',
    toothpastetube: '치약 튜브',
    toothpick: '이쑤시개',
    traditionalchinesemedicine: '한약재 찌꺼기',
    trash: '일반 쓰레기',
    vegetation: '식물성 잔재',
    'white-glass': '투명/백색 유리',
    whiteglass: '투명/백색 유리',
    watermelonrind: '수박 껍질',
    xlight: '형광등',
  },
  reasonHints: {
