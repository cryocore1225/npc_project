...
const zh: Localized = {
  ...
  rawLabels: {
    ...
    xlight: '灯管',
    aerosol: '喷雾罐',
    'aluminium-blister-pack': '铝塑泡罩包装',
    'aluminium-foil': '铝箔',
    background: '背景/非垃圾',
    'broken-glass': '碎玻璃',
    'carded-blister-pack': '纸卡泡罩包装',
    cigarette: '香烟',
    'clear-plastic-bottle': '透明塑料瓶',
    'corrugated-carton': '瓦楞纸箱',
    'crisp-packet': '零食袋',
    'disposable-food-container': '一次性餐盒',
    'disposable-plastic-cup': '一次性塑料杯',
    'drink-can': '饮料罐',
    'drink-carton': '饮料纸盒',
    'egg-carton': '蛋托',
    'foam-cup': '泡沫杯',
    'foam-food-container': '泡沫餐盒',
    'food-can': '食品罐头',
    'food-waste': '食物残渣',
    'garbage-bag': '垃圾袋',
    'glass-bottle': '玻璃瓶',
    ...
    'magazine-paper': '杂志纸',
    'meal-carton': '外卖纸盒',
    'metal-bottle-cap': '金属瓶盖',
    'metal-lid': '金属盖',
    'normal-paper': '普通纸张',
    'other-carton': '其他纸盒',
    'other-plastic': '其他塑料',
    'other-plastic-bottle': '其他塑料瓶',
    'other-plastic-container': '其他塑料容器',
    'other-plastic-cup': '其他塑料杯',
    'other-plastic-wrapper': '其他塑料包装膜',
    'paper-bag': '纸袋',
    'paper-cup': '纸杯',
    'paper-straw': '纸吸管',
    'pizza-box': '披萨盒',
    'plastic-bottle-cap': '塑料瓶盖',
    'plastic-film': '塑料薄膜',
    'plastic-glooves': '塑料手套',
    'plastic-lid': '塑料盖',
    'plastic-straw': '塑料吸管',
    'plastic-utensils': '塑料餐具',
    'polypropylene-bag': '聚丙烯袋',
    'pop-tab': '易拉罐拉环',
    'rope-&-strings': '绳线',
    'scrap-metal': '废金属',
    shoe: '鞋子',
    'single-use-carrier-bag': '一次性购物袋',
    'six-pack-rings': '六连环塑料扣',
    'spread-tub': '涂抹酱盒',
    'squeezable-tube': '可挤压软管',
    'styrofoam-piece': '泡沫塑料块',
    tissues: '纸巾',
    'toilet-tube': '卫生纸筒芯',
    tupperware: '保鲜盒',
    'unlabeled-litter': '未标注垃圾',
    'wrapping-paper': '包装纸',
  },
  reasonHints: {
...
const ko: Localized = {
  ...
  rawLabels: {
    ...
    xlight: '형광등',
    aerosol: '스프레이 캔',
    'aluminium-blister-pack': '알루미늄 블리스터 포장',
    'aluminium-foil': '알루미늄 포일',
    background: '배경/비쓰레기',
    'broken-glass': '깨진 유리',
    'carded-blister-pack': '카드형 블리스터 포장',
    cigarette: '담배',
    'clear-plastic-bottle': '투명 플라스틱 병',
    'corrugated-carton': '골판지 상자',
    'crisp-packet': '과자 봉지',
    'disposable-food-container': '일회용 음식 용기',
    'disposable-plastic-cup': '일회용 플라스틱 컵',
    'drink-can': '음료 캔',
    'drink-carton': '음료 종이팩',
    'egg-carton': '달걀판',
    'foam-cup': '스티로폼 컵',
    'foam-food-container': '스티로폼 음식 용기',
    'food-can': '식품 캔',
    'food-waste': '음식물 쓰레기',
    'garbage-bag': '쓰레기 봉투',
    'glass-bottle': '유리병',
    'glass-cup': '유리컵',
    'glass-jar': '유리병(자)',
    'magazine-paper': '잡지류 종이',
    'meal-carton': '도시락/배달 종이용기',
    'metal-bottle-cap': '금속 병뚜껑',
    'metal-lid': '금속 뚜껑',
    'normal-paper': '일반 종이',
    'other-carton': '기타 종이팩',
    'other-plastic': '기타 플라스틱',
    'other-plastic-bottle': '기타 플라스틱 병',
    'other-plastic-container': '기타 플라스틱 용기',
    'other-plastic-cup': '기타 플라스틱 컵',
    'other-plastic-wrapper': '기타 플라스틱 포장재',
    'paper-bag': '종이봉투',
    'paper-cup': '종이컵',
    'paper-straw': '종이 빨대',
    'pizza-box': '피자 박스',
    'plastic-bottle-cap': '플라스틱 병뚜껑',
    'plastic-film': '비닐 필름',
    'plastic-glooves': '플라스틱 장갑',
    'plastic-lid': '플라스틱 뚜껑',
    'plastic-straw': '플라스틱 빨대',
    'plastic-utensils': '플라스틱 식기',
    'polypropylene-bag': '폴리프로필렌 봉투',
    'pop-tab': '캔 탭',
    'rope-&-strings': '끈/실',
    'scrap-metal': '고철',
    shoe: '신발',
    'single-use-carrier-bag': '일회용 쇼핑백',
    'six-pack-rings': '6팩 링',
    'spread-tub': '스프레드 용기',
    'squeezable-tube': '튜브형 용기',
    'styrofoam-piece': '스티로폼 조각',
    tissues: '휴지',
    'toilet-tube': '화장지 심',
    tupperware: '밀폐용기',
    'unlabeled-litter': '미분류 쓰레기',
    'wrapping-paper': '포장지',
  },
  reasonHints: {
